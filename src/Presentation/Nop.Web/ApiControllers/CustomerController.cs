...
public partial class CustomerController : ControllerBase
{
    ...
    /// </returns>
    [HttpGet("MultiFactorVerification")]
    ...
    //available even when a store is closed
    [CheckAccessClosedStore(ignore: true)]
    [HttpPost("PasswordRecoveryConfirmPOST")]
    ...
    [HttpPost("RemoveExternalAssociation")]
    ...
    //available even when a store is closed
    [CheckAccessClosedStore(ignore: true)]
    [HttpGet("MultiFactorAuthentication")]
    ...
    [HttpGet("ConfigureMultiFactorAuthenticationProvider")]
