...
[ApiController]
public partial class BackInStockSubscriptionController : ControllerBase
{
    #region Fields
    ...
    [HttpPost("CustomerSubscriptions")]
    ...
    [HttpPost("CustomerSubscriptionsPOST")]
