...
public partial class ProductController : ControllerBase
{
    ...
    public virtual async Task<IActionResult> ProductDetails(int productId, int updatecartitemid = 0)
    {
        ...
        return Ok(new { productTemplateViewPath, model });
    }
    ...
    [HttpGet("GetProductCombinations")]
    ...
    public virtual async Task<IActionResult> ProductReviewsAdd(int productId, ProductReviewsModel model, bool captchaValid)
    {
        ...
        return Ok(new { productTemplateViewPath, productModel });
    }

    [HttpPost("SetProductReviewHelpfulness")]
    ...
    [HttpGet("CustomerProductReviews")]
    ...
    [HttpPost("AddProductToCompareList")]
    ...
    [HttpGet("RemoveProductFromCompareList")]
