...
public partial class ShoppingCartController : ControllerBase
{
    ...
    [HttpPost("AddProductToCart_Catalog")]
        ...
        int quantity, bool forceredirection = false)
    {
        ...
        if (product.ProductType != ProductType.SimpleProduct)
            return BadRequest(new { redirect = redirectUrl });
    ...
    [HttpPost("AddProductToCart_Details")]
    ...
    //currently we use this method on the product details pages
    [HttpPost("ProductDetails_AttributeChange")]
    ...
    [HttpPost("UploadFileProductAttribute")]
    ...
    [HttpPost("UploadFileCheckoutAttribute")]
    [IgnoreAntiforgeryToken]
