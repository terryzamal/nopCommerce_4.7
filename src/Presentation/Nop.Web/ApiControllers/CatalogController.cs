...
public class CatalogController : ControllerBase
{
    ...
    [HttpGet("Category")]
    public async Task<IActionResult> Category(int categoryId, CatalogProductsCommand command)
    {
    ...
    public async Task<IActionResult> GetCategoryProducts(int categoryId, CatalogProductsCommand command)
    {
        var category = await _categoryService.GetCategoryByIdAsync(categoryId);
    ...
    [HttpGet("GetCatalogSubCategories/{id}")]
    ...
    public async Task<IActionResult> Manufacturer(int manufacturerId, CatalogProductsCommand command)
    {
    ...
    //ignore SEO friendly URLs checks
    [HttpGet("GetManufacturerProducts")]
    [CheckLanguageSeoCode(ignore: true)]
    public async Task<IActionResult> GetManufacturerProducts(int manufacturerId, CatalogProductsCommand command)
    {
        var manufacturer = await _manufacturerService.GetManufacturerByIdAsync(manufacturerId);
    ...
    [HttpGet("Vendor")]
    public async Task<IActionResult> Vendor(int vendorId, CatalogProductsCommand command)
    {
    ...
    public async Task<IActionResult> GetVendorProducts(int vendorId, CatalogProductsCommand command)
    {
        var vendor = await _vendorService.GetVendorByIdAsync(vendorId);
    ...
    public async Task<IActionResult> ProductsByTag(int productTagId, CatalogProductsCommand command)
    {
    ...
    //ignore SEO friendly URLs checks
    [CheckLanguageSeoCode(ignore: true)]
    [HttpGet("GetTagProducts")]
    public async Task<IActionResult> GetTagProducts(int tagId, CatalogProductsCommand command)
    {
    ...
    [HttpGet("NewProducts")]
    public async Task<IActionResult> NewProducts(CatalogProductsCommand command)
    {
    ...
    public async Task<IActionResult> GetNewProducts(CatalogProductsCommand command)
    {
        if (!_catalogSettings.NewProductsEnabled)
            return NotFound();
    ...
    [CheckLanguageSeoCode(ignore: true)]
    [HttpGet("NewProductsRss")]
    public async Task<IActionResult> NewProductsRss()
    {
        var store = await _storeContext.GetCurrentStoreAsync();
    ...
    #region Searching
    [HttpGet("Search")]
    public async Task<IActionResult> Search(SearchModel model, CatalogProductsCommand command)
    {
        var store = await _storeContext.GetCurrentStoreAsync();
    ...
    [CheckLanguageSeoCode(ignore: true)]
    [HttpGet("SearchTermAutoComplete")]
